...
| 🔁 **Auto-restart** | Automatically bring a task back up if it crashes (with smart backoff) |
| ⏰ **Scheduling** | Run tasks on a cron schedule |
...
7. [Dependencies & Startup Delay](./dependencies.md) — Control start order and timing
8. [Admin Elevation](./admin-elevation.md) — Run tasks as Administrator
9. [Viewing Logs](./logs.md) — The live log viewer plus log files on disk

### 🔧 Configuration & help
10. [Settings](./settings.md) — Every setting explained, plus themes
11. [Notifications & Updates](./notifications-and-updates.md) — Desktop alerts and staying up to date
12. [Configuration Files](./configuration-files.md) — `tasks.yaml`, `settings.yaml`, and the data directory
13. [Troubleshooting](./troubleshooting.md) — Fixes for common problems
14. [FAQ](./faq.md) — Frequently asked questions

---

## A 60-second tour

1. **Open Labalaba.** The background engine starts automatically inside the app — there's nothing else to install or run.
